...
class CustomList {
  ...
  // --- REMOVE ----------------------------------------------------------------
<<<<<<< HEAD
  removeCustom(customName, customPos) {
      const customsList = this.getAllCustoms();
      this.NameOfPosition(customName, customPos, customsList);
      
  }
  removeCustomElement(customName, elementPos, elementName) {}
=======
>>>>>>> parent of 6e967a3 (customList.js [Feature] Remove de customList y customElement)
  // ---------------------------------------------------------------------------
  // --- CLEAR -----------------------------------------------------------------
  // ---------------------------------------------------------------------------
  // --- EDIT ------------------------------------------------------------------
